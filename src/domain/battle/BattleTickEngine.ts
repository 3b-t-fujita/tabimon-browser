...
export const SHIELD_REDUCTION = 0.45; // まもりのたて / いわのよろい のダメージ軽減率（45%減）
export const SHIELD_REDUCTION_DEF_002 = 0.55; // ブリザードアーマー のダメージ軽減率（55%減）
export const SHIELD_REDUCTION_DEF_003 = 0.65; // グレイシャーウォール のダメージ軽減率（65%減）
