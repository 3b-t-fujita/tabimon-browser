...
export function EventPanel({ message, onConfirm, isSaving }: Props) {
  return (
    <div
      className="flex flex-col overflow-hidden rounded-[28px] border border-[#ffd98b] shadow-sm"
      style={{ background: 'linear-gradient(135deg, #fff7e6 0%, #fff1bf 100%)' }}
    >
      {/* ヘッダー */}
      <div
        className="flex items-center gap-2 px-4 py-3"
        style={{ background: 'rgba(255,201,114,0.35)' }}
      >
      ...
      {/* メッセージ */}
      <p className="px-5 py-4 text-sm leading-relaxed text-[#595c57]">{message}</p>
      ...
      <div className="px-4 pb-4">
        <button
          ...
          style={{
            background:  'linear-gradient(135deg, #7d5231, #d97706)',
            boxShadow:   '0 4px 14px rgba(125,82,49,0.35)',
          }}
        >
          <span
